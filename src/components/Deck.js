...
class Deck extends Component {
    constructor(props) {
        ...
        this.state = {
            cards: [
                <Card picsum={`https://picsum.photos/1920/1080`} id="one" key="one" />,
                <Card picsum={`https://picsum.photos/1920/1082`} id="two" key="two" />,
                <Card picsum={`https://picsum.photos/1920/1084`} id="three" key="three" />,
                <Card picsum={`https://picsum.photos/1920/1086`} id="four" key="four" />
            ]
        }
    }
    ...
    update_selection = () => {
        for (let i = 0; i < this.images.children.length; i++) {
            if (i === this.current_card) {
                ...
                this.selection_buttons_container.children[i].style.backgroundColor = '#67ab33';
    ...
    handle_boundaries = () => {
        ...
        if (Math.round(this.last_positions[this.number_of_cards_by_index]) >= this.right_boundary) {
